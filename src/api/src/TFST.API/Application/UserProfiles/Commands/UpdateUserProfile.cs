...
using TFST.Domain.Events;
using TFST.Domain.Repositories.Command;
using TFST.Domain.Services;
using TFST.Domain.Identity.Entities;

namespace TheFullStackTeam.Application.UserProfiles.Commands;
...
public class UpdateUserProfileCommand : IRequest<UserProfileModel>
{
    ...
    public UpdateUserProfileCommand(Guid userProfileId, UpdateUserProfileModel model)
    {
...
{
    private readonly ICommandRepository<User> _userProfileRepository;
    private readonly IEventDispatcher _eventDispatcher;
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly ILogger<UpdateUserProfileCommandHandler> _logger;

    public UpdateUserProfileCommandHandler(
        ICommandRepository<User> userProfileRepository,
